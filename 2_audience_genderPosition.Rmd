...
The audience (number of attendants in the seminar) is modeled by the gender (male, female), the academic position (student, postdoc, professor) of the speaker, and affirmative actions (before, after).
