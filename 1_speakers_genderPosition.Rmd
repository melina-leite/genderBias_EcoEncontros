...
```{r, echo=T}
mod0 <- glmer(fem ~ 1 + ratioFcat + (1|year), 
              family=binomial, data= data)
mod1 <- glmer(fem ~ affirm_action + ratioFcat + (1|year), 
              family=binomial, data= data)
mod2 <- glmer(fem ~ position_cat + ratioFcat + (1|year), 
              family=binomial, data= data)
mod3 <- glmer(fem ~ position_cat + affirm_action + ratioFcat + (1|year), 
              family=binomial, data= data)
mod4 <- glmer(fem ~ position_cat*affirm_action + ratioFcat + (1|year), 
              family=binomial, data= data)
