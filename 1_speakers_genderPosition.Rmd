...
mod8 <- glmer(fem ~ position_cat*affirm_action + ratioFcat + (position_cat|year), 
              family=binomial, data= data)


kable(AICtab(mod0,mod2,mod3,mod6,mod7,mod8, base=T, weights=T), digits=2)
...
summary(mod7)
performance::r2(mod7)
myc7 <- ggpredict(mod7, terms=c("position_cat","affirm_action",
                                 "ratioFcat[1]"))
plot(myc7) +
  geom_hline(yintercept = 0.5, linetype="dashed")
```
