...
plot(ggpredict(mod0ppge, terms=c("propFcat[all]"))) +
  ...
  geom_point(data=datappge, aes(x=propFcat, y=y2, col=position_cat), size=4,
             alpha=0.3)+
  scale_color_manual(values=2:4, name="Academic level")+
  theme(text = element_text(size=20),
        axis.text = element_text(size=18),
...
ggsave(here("figures", "FIG_3_propFemalePPGE.jpeg"), width=8, height = 7)
```
